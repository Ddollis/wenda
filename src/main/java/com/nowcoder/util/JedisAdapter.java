...
public class JedisAdapter implements InitializingBean {
    ...
    public static void main(String[] args) {
        ...
        jedis.rename("hello", "nowhello");
        print(1, jedis.get("nowhello"));
        ...
        print(10, jedis.linsert(listName, BinaryClient.LIST_POSITION.AFTER, "a2", "xxx"));
        print(10, jedis.linsert(listName, BinaryClient.LIST_POSITION.BEFORE, "a4", "xxx2"));
        print(11, jedis.lrange(listName, 0, 12));

        String userKey = "userxx";
        jedis.hset(userKey, "name", "Jim");
        jedis.hset(userKey, "age", "12");
        jedis.hset(userKey, "phone", "1868686868");
        ...
        print(41, jedis.zlexcount(setKey, "(a", "[b"));
        print(42, jedis.zlexcount(setKey, "[a", "[b"));
        jedis.zrem(setKey, "b");
        print(43, jedis.zrange(setKey, 0, 10));
        jedis.zremrangeByLex(setKey, "[a", "(c");
        ...
        User user = new User();
        user.setName("yxy");
        user.setPassword("iou");
        user.setSalt("salt");
        user.setHeadUrl("/dududu");
        user.setId(1);
